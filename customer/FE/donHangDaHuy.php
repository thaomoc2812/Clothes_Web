...
<body>
    ...
    <main role="main">
        <div class="list-group-item">
            ...
            <a href="donHangDaHuy.php?user=<?php echo $sdt ?>" class="list-group-item" style="background-color:darkgray" >Đã hủy</a>
        ...
        $count_sql = "SELECT COUNT(*) AS total FROM donhang WHERE  idkhachhang = $idkhachhang  AND tinhtrang= N'Đã hủy'";
        ...
        { ?>
            ...
            <p class="lead">Chưa có đơn hàng nào bị hủy.</p>
            ...
            <div class="row">
                <div class="col col-md-12">
                    <table class="table table-bordered">
                        ...
                        <tbody id="datarow">
                        <?php
                            $search_donhang= "SELECT * FROM donhang WHERE  idkhachhang = $idkhachhang AND tinhtrang= N'Đã hủy' ";
