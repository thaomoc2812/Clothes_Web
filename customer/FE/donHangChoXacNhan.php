...
<body>
    ...
    <main role="main">
        <div class="list-group-item">
            <a href="donHangChoXacNhan.php?user=<?php echo $sdt ?>" class="list-group-item" style="background-color:darkgray" >Chờ xác nhận</a>
            <a href="donHangDangChuanBi.php?user=<?php echo $sdt ?>" class="list-group-item">Đang chuẩn bị</a>
                        ...
                        <?php
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a onclick="return confirm('Xác nhận hủy đơn hàng?')" href="../BE/donHangDaHuy.php?user=<?php echo $sdt ?>&sid=<?php echo $iddonhang ?>" id="delete_1" data-sp-ma="2" class="btn btn-danger btn-delete-sanpham">
