...
<body>
    ...
    <main role="main">
        <div class="list-group-item">
            ...
            <a href="donHangDangVanChuyen.php?user=<?php echo $sdt ?>" class="list-group-item" style="background-color:darkgray">Đang vận chuyển</a>
                        ...
                        <?php
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="../BE/daMua.php?user=<?php echo $sdt ?>&sid=<?php echo $iddonhang?>" class="btn btn-info">Đã nhận</a>
