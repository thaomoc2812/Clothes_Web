...
<body>
    ...
    <main role="main">
        <div class="list-group-item">
            ...
            <a href="donHangDaMua.php?user=<?php echo $sdt ?>" class="list-group-item"   style="background-color:darkgray">Đã mua</a>
                        ...
                        <?php
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="addNhanXet.php?user=<?php echo $user?>&sid=<?php echo $iddonhang ?>" class="btn btn-info">Thêm nhận xét</a>
                                </td>
                            </tr>
                            <?php 
