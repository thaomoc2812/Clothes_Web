...
<nav class="navbar navbar-default">
    <div class="container-fluid">
        <ul class="nav navbar-nav">
            <li ><a href="viewKhachHangOnline.php?staff=<?php echo $staff ?>">Khách hàng mua online</a></li>
            <li class="active" ><a href="viewKhachHangOffline.php?staff=<?php echo $staff ?>">Khách hàng chỉ mua tại cửa hàng</a></li>
            ...
            ?>
                ...
                <tr>
                    ...
                    $idkhachhang = $r1['id'];
                        ...
                        echo $total;
                        ?></td>
                    <td><a href="viewChiTietKhachHangOffline.php?staff=<?php echo $staff ?>&sid=<?php echo $r1['id'] ?>">Chi tiết</a></br>
