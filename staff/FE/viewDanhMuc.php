    ...
    <nav class="navbar navbar-default">
        <div class="container-fluid">
            <ul class="nav navbar-nav">
                <li><a href="addDanhMuc.php?staff=<?php echo $staff ?>">Thêm danh mục</a></li>
                <li class="active"><a href="addDanhMuc.php?staff=<?php echo $staff ?>">Xem danh sách danh mục</a></li>
            ...
            <tbody>
                ...
                ?>
                    ...
                    <tr>
                        ...
                        <td></td>
                        <td><a href="viewChiTietDanhMuc.php?staff=<?php echo $staff ?>&sid=<?php echo $r2['id'] ?>">Chi tiết</a>
                            <a href="editDanhMuc.php?staff=<?php echo $staff ?>&sid=<?php echo $r2['id'] ?>" class="btn btn-info">Sửa</a>
                            <a onclick="return confirm('Bạn có muốn xóa danh mục này không?')" href="../BE/deleteDanhMuc.php?staff=<?php echo $staff ?>&sid=<?php echo $r2['id'] ?>" class="btn btn-danger">Xóa</a>
                        </td>
