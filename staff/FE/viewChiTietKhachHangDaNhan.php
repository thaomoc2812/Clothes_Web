...
<?php 
        ...
        $search_donhang= "SELECT * FROM donhang WHERE  idkhachhang = $idkhachhang AND tinhtrang = N'Đã nhận'";
        ...
        <div class="container-fluid">
            <ul class="nav navbar-nav">
                ...
                <li class="active"><a href="viewChiTietKhachHangDaNhan.php?staff=<?php echo $staff ?>&sid=<?php echo $idkhachhang ?>">Đã nhận</a></li>
        ...
        $count_sql = "SELECT COUNT(*) AS total FROM donhang WHERE  idkhachhang = $idkhachhang  AND tinhtrang= N'Đã nhận'";
