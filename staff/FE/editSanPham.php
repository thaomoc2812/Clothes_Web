...
<div class="container">
    <form action="../BE/updateSanPham.php?staff=<?php echo $staff?>&idsanpham=<?php echo $idsanpham?>" method="post" enctype="multipart/form-data">
        ...
        <tbody>
            ...
            ?>
                ...
                <tr>
                    ...
                    <form action="../BE/updateSoLuongSanPham.php" method="post" enctype="multipart/form-data">
                    <input type="hidden" name="idsoluong" value="<?php echo $r_soluong['id']?>" id ="">
                    <input type="hidden" name="staff" value="<?php echo $staff?>" id ="staff">
                    ...
                    <th><button type="submit"  hidden>Lưu</button></th>
                    </form>
                </tr>
            <?php
            }
    ...
    <a href="deleteEditSanPham.php?staff=<?php echo $staff ?>" class="btn btn-danger">Xong</a>
</div>
</body>
