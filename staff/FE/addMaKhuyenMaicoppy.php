...
<div class="container">
    ...
    <form action="../BE/addMaKhuyenMai.php" method="post">
        ...
        <tbody>
            ...
            ?>
                    ...
                    <tr>
                        ...
                        <td><a href="../BE/addMaKhuyenMaiSanPham.php?idsoluong=<?php echo $r_soluong2['id'] ?>&makhuyenmai=<?php echo $makhuyenmai ?>&giam=<?php echo $giam ?>&ngaybatdau=<?php echo $ngaybatdau ?>&ngayketthuc=<?php echo $ngayketthuc ?>&&key1=<?php echo "" ?>&key2=<?php echo "" ?>&key3=<?php echo "" ?>" class="btn btn-info">Thêm</a></td>
                    </tr>
            <?php
                }
            }
