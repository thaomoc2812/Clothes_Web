...
<div class="container">
    ...
    <div>
    <form action="../BE/searchSanPhamDaKhuyenMai.php?staff=<?php echo $staff ?>&makhuyenmai=<?php echo $makhuyenmai ?>&giam=<?php echo $giam ?>&ngaybatdau=<?php echo $ngaybatdau ?>&ngayketthuc=<?php echo $ngayketthuc ?>&link=<?php echo "viewChiTietMaKhuyenMaiDangChay" ?>" method="post">
