...
<div class="container">
    ...
    <nav class="navbar navbar-default">
        <div class="container-fluid">
            ...
            <li><a href="choXacNhan.php?staff=<?php echo $staff?>">Chờ xác nhận</a></li>
                ...
                <li class="active"><a href="daSoanDon.php?staff=<?php echo $staff?>">Đã soạn đơn</a></li>
    ...
    <?php 
        ...
        $count_sql = "SELECT COUNT(*) AS total FROM donhang WHERE tinhtrang= N'Đã soạn đơn'";
            ...
            <div class="row">
                <div class="col col-md-12">
                    <table class="table table-bordered">
                        ...
                        <tbody id="datarow">
                        <?php
                            $search_donhang= "SELECT * FROM donhang WHERE  tinhtrang= N'Đã soạn đơn' ";
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="../BE/dangVanChuyen.php?staff=<?php echo $staff?>&sid=<?php echo $iddonhang?>" class="btn btn-info">Đã giao</a>
                                    <a onclick="return confirm('Sửa đơn hàng?')" href="soanDon.php?staff=<?php echo $staff?>&sid=<?php echo $iddonhang ?>" id="delete_1" data-sp-ma="2" class="btn btn-danger btn-delete-sanpham">
                                        <i class="fa fa-trash" aria-hidden="true"></i> Sửa đơn
                                    </a>
