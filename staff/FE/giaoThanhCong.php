    ...
    <nav class="navbar navbar-default">
        <div class="container-fluid">
            ...
            <li><a href="choXacNhan.php?staff=<?php echo $staff?>">Chờ xác nhận</a></li>
                ...
                <li class="active"><a href="giaoThanhCong.php?staff=<?php echo $staff?>">Thành công</a></li>
                    ...
                    <table class="table table-bordered">
                        ...
                        <?php
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="viewChiTietDonHang.php?staff=<?php echo $staff?>&sid=<?php echo $iddonhang ?>&view=<?php echo 1?>">Chi tiết</a></br>
