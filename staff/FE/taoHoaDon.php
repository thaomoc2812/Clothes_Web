...
<nav class="navbar navbar-default">
    <div class="container-fluid">
        <ul class="nav navbar-nav">
            <li class="active"><a href="taoHoaDon.php?staff=<?php echo $staff?>">Tạo đơn</a></li>
            <li ><a href="choXacNhan.php?staff=<?php echo $staff?>">Chờ xác nhận</a></li>
...
$noti = 0;
    ...
    <div class="recipient-info">
            <form action="../BE/searchKhachHang.php" method="post" enctype="multipart/form-data">
            ...
            <form action="../BE/updateKhachHang.php" method="post" enctype="multipart/form-data">
            <div class="form-group">
                <label>Họ tên</label>
    ...
    <?php 
     ...
     if($noti == 1) {?><p style="text-align: center;color:red;font-size: large">Ấn enter cho mỗi lần nhập!</p> <?php } 
        ...
        if($result_donhang = mysqli_query($conn, $search_donhang)){
        ...
        ?>
                    ...
                    <table class="table table-bordered">
                        ...
                        <?php
                            ...
                            <tr>
                                ...
                                <td>
                                <a href="viewChiTietSanPham.php?sid=<?php echo $idsanpham ?>"> <img  src="../../../php/uploads/<?php echo $fetch_hinhanh['hinhanhchinh']?>" class="hinhdaidien" width="100"></a>
                                </td>
                                ...
                                $sum = $sum + $thanhTien;
                                ?></td>
                                <td><a href="../BE/deleteSanPhamTuHoaDon.php?staff=<?php echo $staff ?>&idkhachhang=<?php echo $idkhachhang ?>&staff=<?php echo $staff?>&idsanpham=<?php echo $idsanpham ?>&iddonhang=<?php echo $iddonhang ?>&idttdonhang=<?php echo $fetch_ttdonhang['id'] ?>" class="btn btn-danger" style="color: white;">Xóa</a></td>
            ...
            <?php }}?>
            <form action="../BE/updateDonHang.php" method="post" enctype="multipart/form-data">
                    <input type="text" id="staff" name="staff" value="<?php echo $staff?>" hidden>
                    <input type="text" id="sdt" name="sdt" value="<?php echo $sdt?>" hidden>
                    ...
                    <a href="../BE/deleteDonHang.php?staff=<?php echo $staff?>&iddonhang=<?php echo $iddonhang?>"  class="btn btn-danger" style="color: white;">Hủy</a>
                    </div>
            </form>
            <br><br><br><br><br>
        ...
        ?>
            ...
            <tr>
                ...
                <td><a href="viewChiTietSanPham.php?staff=<?php echo $staff?>&sid=<?php echo $r1['id'] ?>">Chi tiết</a></br>
                    <a href="../BE/addSanPhamVaoHoaDon.php?staff=<?php echo $staff ?>&idkhachhang=<?php echo $idkhachhang ?>&sdt=<?php echo $sdt ?>&iddonhang=<?php echo $iddonhang ?>&idsanpham=<?php echo $r1['id'] ?>" class="btn btn-info">Thêm</a>
...
<div id="popup" class="popup">
    <div class="popup-content">
        ...
        &nbsp;&nbsp;&nbsp;
        <form action="../BE/addSanPhamVaoHoaDonThanhCong.php" method="post" enctype="multipart/form-data">
        <?php
        if (isset($_GET['idsanpham']))
        {
        $idsanpham = $_GET['idsanpham'];
