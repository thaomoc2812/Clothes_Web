    ...
    <nav class="navbar navbar-default">
        <div class="container-fluid">
            ...
            <li><a href="choXacNhan.php?staff=<?php echo $staff?>">Chờ xác nhận</a></li>
                <li  class="active" ><a href="dangChuanBi.php?staff=<?php echo $staff?>">Đang chuẩn bị</a></li>
        ...
        <div class="recipient-info">
            ...
            <div class="row">
                <div class="col col-md-12">
                    <table class="table table-bordered">
                        ...
                        <?php
                            ...
                            <tr>
                                ...
                                <td>
                                <a href="viewChiTietSanPham.php?staff=<?php echo $staff?>&sid=<?php echo $idsanpham ?>"> <img  src="../../../php/uploads/<?php echo $fetch_hinhanh['hinhanhchinh']?>" class="hinhdaidien" width="100"></a>
                                </td>
                                ...
                                <form action="../BE/soanDon.php" method="post" enctype="multipart/form-data" onsubmit="return checkMaLoHang()">
                                    <input id="idttdonhang" name = "idttdonhang" value="<?php  echo $idttdonhang?>" hidden>
                                    <input id="staff" name = "staff" value="<?php  echo $staff?>" hidden>
                    ...
                    <a style="float: right;" href="../BE/huySoanDon.php?staff=<?php echo $staff ?>&sid=<?php echo $iddonhang ?>" class="btn btn-danger">Hủy soạn đơn</a></td>
                    <a style="float: right;"href="../BE/daSoanDon.php?staff=<?php echo $staff ?>&sid=<?php echo $iddonhang ?>" class="btn btn-info">Xong đơn</a>
