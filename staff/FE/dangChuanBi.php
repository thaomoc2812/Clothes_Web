...
<div class="container">
    ...
    <?php 
        ...
        $count_sql = "SELECT COUNT(*) AS total FROM donhang WHERE tinhtrang= N'Đang chuẩn bị'";
            ...
            <div class="row">
                <div class="col col-md-12">
                    <table class="table table-bordered">
                        ...
                        <tbody id="datarow">
                        <?php
                            $search_donhang= "SELECT * FROM donhang WHERE  tinhtrang= N'Đang chuẩn bị' ";
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="soanDon.php?staff=<?php echo $staff ?>&sid=<?php echo $iddonhang?>" class="btn btn-info">Soạn đơn</a>
