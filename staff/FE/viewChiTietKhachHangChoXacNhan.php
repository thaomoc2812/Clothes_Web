...
<?php 
        ...
        $search_donhang= "SELECT * FROM donhang WHERE  idkhachhang = $idkhachhang AND tinhtrang = N'Chờ xác nhận'";
        ...
        <div class="container-fluid">
            <ul class="nav navbar-nav">
                <li class="active"><a href="viewChiTietKhachHangChoXacNhan.php?staff=<?php echo $staff ?>&sid=<?php echo $idkhachhang ?>">Chờ xác nhận</a></li>
                <li><a href="viewChiTietKhachHangDangVanChuyen.php?staff=<?php echo $staff ?>&sid=<?php echo $idkhachhang ?>">Đang vận chuyển</a></li>
        ...
        $count_sql = "SELECT COUNT(*) AS total FROM donhang WHERE  idkhachhang = $idkhachhang  AND tinhtrang= N'Chờ xác nhận'";
