...
<?php 
        ...
        $search_donhang= "SELECT * FROM donhang WHERE  idkhachhang = $idkhachhang AND tinhtrang = N'Đang vận chuyển'";
        ...
        <div class="container-fluid">
            <ul class="nav navbar-nav">
                <li ><a href="viewChiTietKhachHangChoXacNhan.php?staff=<?php echo $staff ?>&sid=<?php echo $idkhachhang ?>">Chờ xác nhận</a></li>
                <li class="active"><a href="viewChiTietKhachHangDangVanChuyen.php?staff=<?php echo $staff ?>&sid=<?php echo $idkhachhang ?>">Đang vận chuyển</a></li>
                <li><a href="viewChiTietKhachHangDaNhan.php?staff=<?php echo $staff ?>&sid=<?php echo $idkhachhang ?>">Đã nhận</a></li>
                <li ><a href="viewChiTietKhachHangDaMuaOffline.php?staff=<?php echo $staff ?>&sid=<?php echo $idkhachhang ?>">Đã mua tại cửa hàng</a></li>
            </ul>
        </div>
    </nav>
        <?php
        ...
        $count_sql = "SELECT COUNT(*) AS total FROM donhang WHERE  idkhachhang = $idkhachhang  AND tinhtrang= N'Đang vận chuyển'";
