...
if($soluong > ($r_ttlohang['conlai']))
{
    ...
    header("Location: ../FE/soanDon.php?staff=$staff&sid=$iddonhang&check=2");
    exit();
}
...
if(mysqli_query($conn, $update_sql1) && mysqli_query($conn, $update_sql2) && mysqli_query($conn, $update_sql3)){
    ...
    header("Location: ../FE/soanDon.php?staff=$staff&sid=$iddonhang&check=0");
    exit();
...
{
    header("Location: ../FE/soanDon.php?staff=$staff&sid=$iddonhang&check=1");
    exit();
}
?>
