...
if (!$sdt ||!preg_match("/^[0-9]{10}$/", $sdt) )
    {
        header("Location: ../FE/taoHoaDon.php?staff=$staff&noti=2");
        exit;
    }
...
{
    $idkhachhang = $r_kh['id'];
    header("Location: ../FE/taoHoaDon.php?staff=$staff&idkhachhang=$idkhachhang&sdt=$sdt");
    exit();
...
else
{
    ...
    header("Location: ../FE/taoHoaDon.php?staff=$staff&idkhachhang=$last_id&sdt=$sdt");
}