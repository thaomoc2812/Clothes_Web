...
<?php 
        ...
        <div class="container-fluid">
            <ul class="nav navbar-nav">
                ...
                <li class="active"><a href="viewChiTietKhachHangDangVanChuyen.php?sid=<?php echo $idkhachhang ?>">Đang vận chuyển</a></li>
                <li><a href="viewChiTietKhachHangDaNhan.php?sid=<?php echo $idkhachhang ?>">Đã nhận</a></li>
                <li ><a href="viewChiTietKhachHangDaMuaOffline.php?sid=<?php echo $idkhachhang ?>">Đã mua tại cửa hàng</a></li>
            </ul>
        </div>
    </nav>
        <?php
