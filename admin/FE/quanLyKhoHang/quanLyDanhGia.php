...
<div class="container">
    <h1 style="text-align: center;">Quản lý đánh giá từ khách hàng</h1>
                    ...
                    <table class="table table-bordered">
                        ...
                        <?php
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="../quanLyDonHang/viewChiTietDonHang.php?sid=<?php echo $iddonhang ?>&view=<?php echo 1?>">Chi tiết</a></br>
