...
<div class="container">
    ...
    <nav class="navbar navbar-default">
        <div class="container-fluid">
            <ul class="nav navbar-nav">
                ...
                <li class="active"><a href="daHuy.php">Đã hủy</a></li>
    ...
    <?php 
        ...
        $count_sql = "SELECT COUNT(*) AS total FROM donhang WHERE tinhtrang= N'Đã hủy'";
            ...
            <div class="row">
                <div class="col col-md-12">
                    <table class="table table-bordered">
                        ...
                        <tbody id="datarow">
                        <?php
                            $search_donhang= "SELECT * FROM donhang WHERE  tinhtrang= N'Đã hủy'";
