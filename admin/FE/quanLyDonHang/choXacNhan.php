    ...
    <nav class="navbar navbar-default">
        <div class="container-fluid">
            <ul class="nav navbar-nav">
                <li class="active"><a href="choXacNhan.php">Chờ xác nhận</a></li>
                        ...
                        <?php
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="../../BE/quanLyDonHang/dangChuanBi.php?sid=<?php echo $iddonhang?>" class="btn btn-info">Xác nhận</a>
                                    <a onclick="return confirm('Xác nhận hủy đơn hàng?')" href="../../BE/quanLyDonHang/huyDonHang.php?sid=<?php echo $iddonhang ?>" id="delete_1" data-sp-ma="2" class="btn btn-danger btn-delete-sanpham">
