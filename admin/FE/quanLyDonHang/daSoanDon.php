    ...
    <nav class="navbar navbar-default">
        <div class="container-fluid">
            <ul class="nav navbar-nav">
                ...
                <li class="active"><a href="daSoanDon.php" >Đã soạn đơn</a></li>
                        ...
                        <?php
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="../../BE/quanLyDonHang/dangVanChuyen.php?sid=<?php echo $iddonhang?>" class="btn btn-info">Đã giao</a>
                                    <a onclick="return confirm('Sửa đơn hàng?')" href="soanDon.php?sid=<?php echo $iddonhang ?>" id="delete_1" data-sp-ma="2" class="btn btn-danger btn-delete-sanpham">
