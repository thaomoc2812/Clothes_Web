...
<div class="container">
    ...
    <nav class="navbar navbar-default">
        <div class="container-fluid">
            ...
            <li class=""><a href="taoHoaDon.php">Tạo hóa đơn</a></li>
            <li class="active"><a href="offline.php">Đơn hàng tại cửa hàng</a></li>
    ...
    <?php 
        ...
        $count_sql = "SELECT COUNT(*) AS total FROM donhang WHERE tinhtrang= N'Offline'";
            ...
            <div class="row">
                <div class="col col-md-12">
                    <table class="table table-bordered">
                        ...
                        <tbody id="datarow">
                        <?php
                            $search_donhang= "SELECT * FROM donhang WHERE  tinhtrang= N'Offline' ";
