    ...
    <nav class="navbar navbar-default">
        <div class="container-fluid">
            <ul class="nav navbar-nav">
                ...
                <li class="active"><a href="dangVanChuyen.php">Đang vận chuyển</a></li>
                <li><a href="giaoThanhCong.php">Giao thành công</a></li>
                        ...
                        <?php
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <?php if($tinhtrang == "Đang vận chuyển"){?><a href="../../BE/quanLyDonHang/daGiaoDenNoi.php?sid=<?php echo $iddonhang?>" class="btn btn-info">Đã giao đến nơi</a><?php }?>
