...
{
    header("Location: ../../FE/quanLyDonHang/taoHoaDon.php?staff=$staff&idkhachhang=$idkhachhang&sdt=$sdt&idsanpham=$idsanpham&iddonhang=$iddonhang&check=3&add=1");
}
...
if($result_sl = mysqli_query($conn, $search_sl)){
    ...
    if($check_sl < $soluong)
    {
        header("Location: ../../FE/quanLyDonHang/taoHoaDon.php?staff=$staff&idkhachhang=$idkhachhang&sdt=$sdt&idsanpham=$idsanpham&iddonhang=$iddonhang&check=2&add=1");
        exit();
    }
    else
    {
        ...
        if($result_lohang = mysqli_query($conn, $search_lohang))
        {
            ...
            if($result_ttlohang = mysqli_query($conn, $search_ttlohang))
            {
                ...
                if($soluong > $conlai)
                {
                    header("Location: ../../FE/quanLyDonHang/taoHoaDon.php?staff=$staff&idkhachhang=$idkhachhang&sdt=$sdt&idsanpham=$idsanpham&iddonhang=$iddonhang&check=5&add=1");
                    exit();
                }
            ...
            {
                header("Location: ../../FE/quanLyDonHang/taoHoaDon.php?staff=$staff&idkhachhang=$idkhachhang&sdt=$sdt&idsanpham=$idsanpham&iddonhang=$iddonhang&check=4&add=1");
                exit();
            }
...
{
    header("Location: ../../FE/quanLyDonHang/taoHoaDon.php?staff=$staff&idkhachhang=$idkhachhang&sdt=$sdt&idsanpham=$idsanpham&iddonhang=$iddonhang&check=1&add=1");
    exit();
}
