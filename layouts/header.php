...
if($sdt != 0)
{
	...
	if($result_khach = mysqli_query($conn, $search_khach))
	{
		if($fetch_khach= mysqli_fetch_assoc($result_khach))
		{
	...
	<div class="container">
		<div class="row align-items-center evo-search-desktop">
			...
			<div class="col-xl-7 col-lg-6 evo-searchs">
				<form action="#" method="post" class="evo-header-search-form evo-search-form" role="search">
			...
			<div class="col-xl-3 col-lg-4 ant-account d-lg-flex d-none">
				<div class="evo-main-account">
					<a href="../customer/FE/taiKhoan.php?user=<?php echo $sdt ?>" class="header-account" aria-label="Tài khoản" title="Tài khoản">
				...
				<a href="../customer/FE/viewGioHang.php?user=<?php echo $sdt ?>" class="evo-header-cart" aria-label="Xem giỏ hàng" title="Giỏ hàng">
					...
					<span class="count_item_pr"><?php echo $countGioHang; ?></span>
	...
	<li class="  nav-item has-childs   has-mega">
		...
		<div class="mega-content">
				...
				<div class="row">
					...
					<div class="level0 col-lg-6">
						...
						while ($r2 = mysqli_fetch_assoc($result2)) {
							...
							?>
							<div class="level1">
							<a class="hmega" href="../customer/FE/viewTungPhanLoaiSanPham.php?user=<?php echo $sdt?>&sid=<?php echo $r2['loaisanpham'] ?>"><?php echo $r2['loaisanpham']?></a>
									<?php
									...
									?>
										<a class="level2" href="../customer/FE/viewTungDanhMucSanPham.php?user=<?php echo $sdt ?>&loaisanpham=<?php echo $r2['loaisanpham']?>&tendanhmuc=<?php echo $r3['tendanhmuc'] ?>"><?php echo  $r3['tendanhmuc'] ?></a>
			...
			<li class="nav-item  sale-menu">
				<a class="nav-link" href="../customer/FE/viewSale.php?user=<?php echo $sdt ?>" title="Sale" >Sale</a>
			</li>
